...
const SpecialityItem = ({ title, icon }) => {
  return (
    <div className="w-1/2 md:w-[12rem]">
      <div
        className="w-4/5 mx-auto hover:bg-indigo-50 hover:shadow-lg hover:scale-105 transition-all duration-100 hover:shadow-gray-300/50 cursor-pointer rounded-2xl flex flex-col
