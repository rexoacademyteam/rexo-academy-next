          ...
          <div className="flex-col justify-around align-middle">
            <div className="flex flex-col lg:flex-row justify-center items-center">
              ...
              <div className="flex-col justify-around align-middle mr-4">
                ...
                <h1 className="text-lg text-center md:text-start">
                  آموزش برنامه نویسی | فوتوشاپ | پروژه محور | پشتیبانی دائمی
                </h1>
              </div>
            </div>
            <div className="md:max-w-lg w-auto p-3 md:w-full mt-5">
              <p className="text-base text-center md:text-start mb-4 md:mb-2 text-gray-700">
                هدف آکادمی رکسو ارائه بهترین دوره های آموزش برنامه نویسی و
                فوتوشاپ به دانشجویان برای ورود به بازار کار است و برای رسیدن به
                این هدف یک سری استانداردها تعیین شده و به صورت سختگیرانه روی
                دوره ها اعمال میشود. این استاندار ها شامل تدریس سلیس و روان برای
                انتقال مفاهیم در کنار کامل و جامع بودن دوره ها است به صورتی که
                با دیدن یک دوره به سطح مناسب و حرفه ای برسید. همچنین دوره ها
                پروژه محور هستند تا کاربرد مفاهیمی که یاد میگیرید را درک کنید و
                اگر احیانا ابهامی پیش آید میتوانید از پشتیبانی دائمی‌ ما استفاده
                کنید و سوال هایتان را بپرسید. و در آخر به یکی از مهم ترین ویژگی
                دوره ها اشاره میکنم و آن هم آپدیت و بروز بودن آن ها مطابق آخرین
                تکنولوژی ها میباشد.
              </p>
              <div className="flex justify-around mt-4">
                <div className="inline-flex justify-center align-center rounded-full text-gray-600 hover:bg-gray-200 p-2 text-center hover:scale-[150%] transform transition duration-200">
                  <a href="">
                    <svg
                      stroke="currentColor"
                      fill="currentColor"
          ...
          <div>
            <div className="w-full py-4">
              <div className="flex flex-col gap-4">
                <h1 className="text-center font-bold text-gray-800 border-b-2 border-indigo-800 text-2xl pb-4">
                  بخش های سایت
                </h1>
