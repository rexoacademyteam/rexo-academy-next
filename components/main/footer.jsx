        ...
        <div>
          <div className="w-full py-4">
            <div className="flex flex-col gap-4">
                <p className="text-center font-bold text-gray-800 text-lg border-b-2 border-gray-700">بخش های سایت</p>
